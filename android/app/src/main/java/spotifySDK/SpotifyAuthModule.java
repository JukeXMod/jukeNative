...
public class SpotifyAuthModule extends ReactContextBaseJavaModule implements ActivityEventListener {
    ...
    public SpotifyAuthModule(ReactApplicationContext reactContext) {
        super(reactContext);
