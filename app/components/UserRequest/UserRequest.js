...
export default class UserRequest extends Component {
  ...
  render() {
    return (
      ...
      <Button style = {styles.button} onPress={() => this.props.nav.navigate('ClientQueueView')}> <Image style = {styles.turntable} source={require('../../images/vinyl2.png')} resizeMode="contain"/>
        </Button>
        </View>
     	</View>
    );
